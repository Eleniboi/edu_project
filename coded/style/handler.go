...
func registrationHandler(w http.ResponseWriter, r *http.Request) {
	...
	//validation check first
	if _, exist := UserInfo[email]; exist {
		http.Error(w, "Email already exist!!", http.StatusConflict)
		return
	}

	//load user info into the map 
...
func loginHandler(w http.ResponseWriter, r *http.Request) {
	...
	switch {
	// this method is more effecient for password and email validation
	//
	case !ok:
		data := Validate{
	...
	//this protect against going to the main page without login or registeration
...
func pageHandler(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Printf("Logged in as: %s", Cookie.Value)
