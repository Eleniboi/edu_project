...
// parseInt64 parses a base-10 signed integer from s.
// returns (value, true) on success, (0, false) on invalid or overflow.
...
// itoaInt64 converts an int64 to decimal string (no extra newline).
